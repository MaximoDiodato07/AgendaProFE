...
import { updateTurn } from "../../services/turno.service";
import { showLoading, hideLoading, showOperation } from "../../App";
import OperationMessage from '../OperationMessage';


export default function editTurnModal({setModal, turno, horarios, recharge}) {
    ...
    async function handleSubmit () {
        ...
        const response = await updateTurn(turno.idTurno, date, hour);
        if (response){
            setModal(0);
            recharge();  
                ...
                <div className="add-turn-modal-content">
                    ...
                    <div className="add-turn-modal-footer">
                        ...
                        <div className="add-turn-buttons">
                            ...
                            <button className="btn secondary-btn get-date-button" disabled={!isValidData} onClick={() => handleSubmit()}> Reprogramar Cita </button>
                        </div>
                    </div>
